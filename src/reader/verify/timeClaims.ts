// Source Kit 0.1.0 — dead-code gate does not remove it
/**
 ...
 * injected — every input is already committed under the record signature, so
 * wiring it is a rendering job and nothing more.
 *
 * Time coherence — do the committed time claims agree with each other?
 *
