#!/usr/bin/env node
// Source Kit 0.1.0 — build and supply-chain scripts
...
const BUDGET = {
  'package.json': {
    allow: [
      ...
      'expo-image-manipulator', 'expo-linear-gradient', 'expo-linking',
      ...
      // CI-only: names files no entry point reaches. Never shipped.
      'knip',
    ],
    cap: 43,
  },
