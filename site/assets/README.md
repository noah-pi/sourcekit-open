<!-- Source Kit 0.1.0 — where the screenshots come from -->
# site/assets
...
| File | Credit | Status |
|---|---|---|
| `cottingley.jpg` | Elsie Wright, 1917; first published in *The Strand*, December 1920 | Public domain in the United States (published pre-1929). UK term is less settled — the photographer died in 1988. |
